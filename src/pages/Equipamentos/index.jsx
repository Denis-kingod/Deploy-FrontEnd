...
export const Equipamentos = () => {
    ...
    const Cadastrar = (event) => {
      ...
      axios({
        method: "post",
        url: "https://apisitegp1.azurewebsites.net/api/Equipamentos",
        data: formData,
    ...
    const Listar = () => {
      axios.get('https://apisitegp1.azurewebsites.net/api/Equipamentos')
      .then(resposta => {
    ...
    const Remover = (id) => {
      axios.delete('https://apisitegp1.azurewebsites.net/api/Equipamentos/'+id)
      .then(() => {
        Listar();
      })
      .catch(erro => console.log(erro))
          ...
          <main className="container">
            ...
            {produtos.map(item => 
              <div className="card" key={item.id}>
                <img src={"https://apisitegp1.azurewebsites.net/StaticFiles/Images/"+item.imagem} alt="" />
                <div>
